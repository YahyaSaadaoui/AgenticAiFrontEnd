...
import { PenTool, Send, Menu, X, Settings } from "lucide-react"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const assistantMessage: Message = {
        ...
        role: "assistant",
        content: `Hello! I'm CreativeFlow, your creative content specialist. I can help you with copywriting, creative ideation, brand strategy, and content creation. What creative project can I help you with today?`,
        timestamp: new Date(),
      }
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-lg font-semibold">CreativeFlow</h1>
                    <p className="text-sm text-gray-400">Creative Content Specialist</p>
                  </div>
                </div>
              </div>
            ...
            {!currentChat || currentChat.messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center">
                <motion.div
                  ...
                  className="w-20 h-20 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mb-6"
                >
                  <PenTool className="h-10 w-10 text-white" />
                </motion.div>
                <h2 className="text-2xl font-bold mb-2">Welcome to CreativeFlow</h2>
                <p className="text-gray-400 mb-8 max-w-md">
                  I'm your creative content specialist. I can help you with copywriting, creative ideation, brand
                  strategy, and engaging content creation.
                </p>
            ...
            <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
              <div className="flex gap-4">
                <Input
                  ...
                  placeholder="Ask CreativeFlow to help with your creative projects..."
