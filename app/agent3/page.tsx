...
import { Code, Send, Menu, X, Settings } from "lucide-react"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const assistantMessage: Message = {
        ...
        role: "assistant",
        content: `Hi! I'm CodeCraft, your intelligent coding assistant. I can help you with code generation, debugging, architecture design, and code reviews. What coding challenge can I help you solve today?`,
        timestamp: new Date(),
      }
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Code Generation Specialist</p>
                  </div>
                </div>
              </div>
            ...
            {!currentChat || currentChat.messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center">
                <motion.div
                  ...
                  className="w-20 h-20 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mb-6"
                >
                  <Code className="h-10 w-10 text-white" />
                </motion.div>
                <h2 className="text-2xl font-bold mb-2">Welcome to CodeCraft</h2>
                <p className="text-gray-400 mb-8 max-w-md">
                  I'm your intelligent coding assistant. I can help you generate code, debug issues, design
                  architecture, and review your code for best practices.
                </p>
            ...
            <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
              <div className="flex gap-4">
                <Input
                  ...
                  placeholder="Ask CodeCraft to help with your coding projects..."
